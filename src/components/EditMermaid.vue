...
import MiniMermaidEditor from './MiniMermaidEditor.vue'
...
const diagram_src = ref("");   // v-model:diagram_src = "diagram_src"
const diagram_svg = ref("");   // v-model:diagram_svg = "diagram_svg"
